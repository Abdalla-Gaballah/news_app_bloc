...
import 'package:news/elements/loader.dart';
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: _searchController.text.length > 0 ? IconButton(
                  icon: Icon(EvaIcons.backspaceOutline, color: Colors.grey[500],
                    size: 16.0,),
                  onPressed: () {
                    setState(() {
                ...
                EvaIcons.searchOutline, color: Colors.grey[500], size: 16.0,),
